// eventstream.go — ESL event stream abstraction
...
// NewEventStream creates an EventStream that continuously reads events
// from a FreeSWITCH Event Socket connection into channels.
