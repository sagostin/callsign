...
func (r *Router) Init() {
	...
	featureCodes.Get("/modules", r.Handler.ListFeatureCodeModules)
	featureCodes.Post("/provision", r.Handler.ProvisionFeatureCodeModules)
	featureCodes.Delete("/deprovision", r.Handler.DeprovisionFeatureCodeModules)
