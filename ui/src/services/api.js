...
export const featureCodesAPI = {
    ...
    listModules: () => api.get('/feature-codes/modules'),
    provision: (modules) => api.post('/feature-codes/provision', { modules }),
    deprovision: (modules) => api.delete('/feature-codes/deprovision', { data: { modules } }),
